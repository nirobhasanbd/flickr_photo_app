...
class PhotoSearchViewModel {
    ...
    func searchPhoto(onResult: @escaping (_ message: String?, _ error: String?) -> Void) {
        let params: [String: String] = ["method": APIConstants.searchMethod, "api_key": APIConstants.api_key, "format": APIConstants.format, "nojsoncallback": "1", "secrete": APIConstants.secrete, "media": APIConstants.media, "per_page": "30", "text": searchText]
    ...
    func loadMorePhoto(onResult: @escaping (_ message: String?, _ error: String?) -> Void) {
        let params: [String: String] = ["method": APIConstants.searchMethod, "api_key": APIConstants.api_key, "format": APIConstants.format, "nojsoncallback": "1", "secrete": APIConstants.secrete, "media": APIConstants.media, "page": "\(page)", "per_page": "30", "text": searchText]
